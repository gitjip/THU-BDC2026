...
case "$profile" in
  ...
  full)
    ...
    ;;
  *)
    echo "未知 tune profile: $profile，可选 quick、balanced、noid、noid-lowvol、ensemble-lowvol、noid-marketrel、noid-rank、noid-rank-lite、noid-rank-replace、noid-rank-sharp、noid-rank-trendq、noid-rank-cleanrisk、noid-stable、noid-full、smooth、stable、large、full。" >&2
    exit 2
    ;;
esac
